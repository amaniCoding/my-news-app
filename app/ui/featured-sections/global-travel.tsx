...
export default function GlobalTravel() {
    return (
        <div>
            ...
            <Link href={`#`} className="font-bold block text-lg hover:underline">A librarian ran off with a yacht captain in the summer of 1968. It was the start of an incredible love story</Link>
